...
Insert the SD card into your host machine, and substitute *mmcblk0* with the block device associated the card.
...
Insert the SD card into the device, connect to UART2 (1500000 baud 8N1), and supply power to the device.
...
### Expose the SD card as a USB Mass Storage Device

```
=> ums 0 mmc 1
UMS: LUN 0, dev 1, hwpart 0, sector 0x0, count 0x1db4000
-
^]
dterm> quit
# tail -n 20 /var/log/messages | grep -E 'usb |sd '
Jun 25 16:49:07 workstation kernel: [33199846.372100] usb 5-5.3: new high-speed USB device number 96 using ehci-pci
Jun 25 16:49:07 workstation kernel: [33199846.480723] usb 5-5.3: New USB device found, idVendor=2207, idProduct=320a
Jun 25 16:49:07 workstation kernel: [33199846.480727] usb 5-5.3: New USB device strings: Mfr=1, Product=2, SerialNumber=0
Jun 25 16:49:07 workstation kernel: [33199846.480730] usb 5-5.3: Product: USB download gadget
Jun 25 16:49:07 workstation kernel: [33199846.480733] usb 5-5.3: Manufacturer: Rockchip
Jun 25 16:49:08 workstation kernel: [33199847.480892] sd 415:0:0:0: Attached scsi generic sg4 type 0
Jun 25 16:49:08 workstation kernel: [33199847.481921] sd 415:0:0:0: [sdd] 31145984 512-byte logical blocks: (15.9 GB/14.8 GiB)
Jun 25 16:49:08 workstation kernel: [33199847.482236] sd 415:0:0:0: [sdd] Write Protect is off
Jun 25 16:49:08 workstation kernel: [33199847.482606] sd 415:0:0:0: [sdd] Write cache: enabled, read cache: enabled, doesn't support DPO or FUA
Jun 25 16:49:08 workstation kernel: [33199847.512337] sd 415:0:0:0: [sdd] Attached SCSI removable disk
# lsblk /dev/sdd
